    ...
    ["chunk-4b8279c9"], {
        ...
        "406a": function(t, s, A) {
            ...
            var e = function() {
                    ...
                    methods: {
                        go() {
                            ...
                            let e = 360 * Math.random() + 1080,
                                i = Math.floor((e + 18) % 360 / 36);
                            console.log("num", e), console.log("index", 11 - i), s.style.transition = "all 0s", s.style.transform = "rotate(0deg)", setTimeout(() => {
                                ...
                                this.text = 0 == i ? this.tableList[1] : this.tableList[11 - i], this.showText = !0, this.gobtn = !0
                            }, 6e3)
                        }, turnHome() {
                            this.$router.push({
                                name: "home",
                ...
                c = o,
                n = (A("4609"), A("2877")),
                l = Object(n["a"])(c, e, i, !1, null, "54f446f7", null);
            s["default"] = l.exports
        },
        4609: function(t, s, A) {
            "use strict";
        ...
        cc18: function(t, s, A) {
            ...
            var e = function() {
                ...
                o = a,
                c = (A("d297"), A("2877")),
                n = Object(c["a"])(o, e, i, !1, null, "7ed464c4", null);
            s["a"] = n.exports
        },
        d297: function(t, s, A) {
            "use strict";
