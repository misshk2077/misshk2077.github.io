    ...
    ["chunk-3a6b8ea4"], {
        ...
        cc18: function(e, t, a) {
            ...
            var A = function() {
                    ...
                    }), t("span", [e._v(e._s(e.title))]), t("img", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.showNewGame,
                ...
                m = l,
                o = (a("d297"), a("2877")),
                i = Object(o["a"])(m, A, s, !1, null, "7ed464c4", null);
            t["a"] = i.exports
        },
        d297: function(e, t, a) {
            "use strict";
        ...
        e248: function(e, t, a) {
            ...
            var A = function() {
                ...
                o = {
                    ...
                    methods: {
                        save() {
                            this.m.who && this.m.m1 && this.m.m2 && this.m.m3 && this.m.m4 && this.m.m5 && this.m.m6 && this.m.m7 && this.m.m8 && this.m.m9 && this.m.m10 && this.m.m11 && this.m.m12 ? this.showTip = !0 : Object(l["a"])("数据未填写完整，请填写完整后再提交")
                        }, putGame() {
                            if (this.name) {
                                let e = {
                                    name: this.name,
                                    list: [this.m.who, this.m.m1, this.m.m2, this.m.m3, this.m.m4, this.m.m5, this.m.m6, this.m.m7, this.m.m8, this.m.m9, this.m.m10, this.m.m11, this.m.m12]
                                };
                                if (localStorage.getItem("diceList")) {
                                    let t = JSON.parse(localStorage.getItem("diceList"));
                                    t.push(e), console.log("obj2", t), localStorage.setItem("diceList", JSON.stringify(t))
                                } else localStorage.setItem("diceList", JSON.stringify([e]));
                                Object(l["a"])("保存成功"), this.turnHome()
                            } else Object(l["a"])("请输入游戏名称")
                        }, turnHome() {
                            this.$router.push({
                                name: "home",
                                params: {
                ...
                i = o,
                n = (a("abd8"), a("2877")),
                c = Object(n["a"])(i, A, s, !1, null, "daad7862", null);
            t["default"] = c.exports
        }
    }
]);