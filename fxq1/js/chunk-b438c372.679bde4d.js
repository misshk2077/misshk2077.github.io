        ...
        "13ac": function(s, t, i) {
            ...
            var e = function() {
                ...
                f = {
                    ...
                    created() {},
                    mounted() {
                        if (1 == this.$route.params.type) this.titleName = "基础模式", this.planelist = this.list1, this.setBgc(1);
                        else if (2 == this.$route.params.type) this.titleName = "恋爱版", this.planelist = this.list2, this.setBgc(2);
                        else if (3 == this.$route.params.type) this.titleName = "情侣版", this.planelist = this.list3, this.setBgc(3);
                        else if (4 == this.$route.params.type) this.titleName = "高级版", this.planelist = this.list4, this.setBgc(4);
                        else if (5 == this.$route.params.type) this.titleName = "私密版", this.planelist = this.list5, this.setBgc(5);
                        else if (6 == this.$route.params.type) this.titleName = "组合模式", this.planelist = this.list6, this.setBgc(6);
