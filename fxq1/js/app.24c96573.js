(function(e) {
    function n(n) {
        for (var a, r, u = n[0], s = n[1], i = n[2], f = 0, d = []; f < u.length; f++) r = u[f], Object.prototype.hasOwnProperty.call(c, r) && c[r] && d.push(c[r][0]), c[r] = 0;
    ...
    function t() {
        for (var e, n = 0; n < o.length; n++) {
            for (var t = o[n], a = !0, r = 1; r < t.length; r++) {
                var u = t[r];
                0 !== c[u] && (a = !1)
            }
    ...
    function u(e) {
        return s.p + "js/" + ({}[e] || e) + "." + {
            ...
            "chunk-32210696": "f4f3f989",
            "chunk-3a6b8ea4": "c47e7d57",
            "chunk-4b8279c9": "bd998a51",
            "chunk-93bc65a6": "3158abb6",
            "chunk-945d2f6a": "d044b858",
    ...
    s.e = function(e) {
        ...
        r[e] ? n.push(r[e]) : 0 !== r[e] && t[e] && n.push(r[e] = new Promise((function(n, t) {
            for (var a = "css/" + ({}[e] || e) + "." + {
                ...
                "chunk-32210696": "2bff99ba",
                "chunk-3a6b8ea4": "6fab17dc",
                "chunk-4b8279c9": "129ee97c",
                "chunk-93bc65a6": "af4245c8",
                "chunk-945d2f6a": "273a3f51",
                "chunk-b0a6332a": "2eea0d65",
                "chunk-b438c372": "63185018"
            }[e] + ".css", c = s.p + a, o = document.getElementsByTagName("link"), u = 0; u < o.length; u++) {
                var i = o[u],
                    f = i.getAttribute("data-href") || i.getAttribute("href");
                if ("stylesheet" === i.rel && (f === a || f === c)) return n()
            }
            ...
            l.rel = "stylesheet", l.type = "text/css", l.onload = n, l.onerror = function(n) {
                ...
                o.code = "CSS_CHUNK_LOAD_FAILED", o.request = a, delete r[e], l.parentNode.removeChild(l), t(o)
            }, l.href = c;
    ...
    "56d7": function(e, n, t) {
        ...
        const V = [{
                path: "/",
                name: "home",
                component: () => t.e("chunk-93bc65a6").then(t.bind(null, "37f9"))
            }, {
                path: "/truthOrDare/:type",
                name: "truthOrDare",
                component: () => t.e("chunk-32210696").then(t.bind(null, "b350"))
            }, {
                path: "/plane/:type",
                name: "plane",
                ...
                path: "/dice/:type",
                name: "dice",
                component: () => t.e("chunk-945d2f6a").then(t.bind(null, "fadc"))
            }, {
                path: "/setDice",
                name: "setDice",
                ...
                path: "/turnTable/:type",
                name: "turnTable",
                component: () => t.e("chunk-4b8279c9").then(t.bind(null, "406a"))
            }, {
                path: "/setTable",
                name: "setTable",
        ...
        var ee = X,
            ...
            re = ae,
            ce = (t("15cd"), t("2877")),
            oe = Object(ce["a"])(re, ne, te, !1, null, "ebe2db8e", null),
            ue = oe.exports,
            se = (t("54f4"), t("98c9"));
        Z.a.component("svg-icon", ue), Z.a.prototype.$ImagePreview = J["a"], Z.a.use(se["a"]), Z.a.config.productionTip = !1, Z.a.config.productionTip = !1, Z.a.use(a["a"]).use(r["a"]).use(c["a"]).use(o["a"]).use(u["a"]).use(s["a"]).use(i["a"]).use(f["a"]).use(d["a"]).use(l["a"]).use(p["a"]).use(b["a"]).use(h["a"]).use(m["a"]).use(v["a"]).use(g["a"]).use(y["a"]).use(k["a"]).use(w["a"]).use(_["a"]).use(O["a"]).use(x["a"]).use(E["a"]).use(S["a"]).use(T["a"]).use(j["a"]).use(N["a"]).use(P["a"]).use(I["a"]).use(D["a"]).use(F["a"]).use(C["a"]).use(A["a"]).use(L["a"]).use(M["a"]).use(B["a"]).use(G["a"]).use(U["a"]).use(q["a"]).use(R["a"]).use($["a"]), new Z.a({
            router: ee,
            store: Q,
    ...
    cfd9: function(e, n, t) {
        ...
        }, r.resolve = c, e.exports = r, r.id = "cfd9"
    }
});