        ...
        "8e35": function(e, t, A) {
            ...
            var a = function() {
                ...
                m = {
                    ...
                    methods: {
                        save() {
                            this.m.m1 && this.m.m2 && this.m.m3 && this.m.m4 && this.m.m5 && this.m.m6 && this.m.m7 && this.m.m8 && this.m.m9 && this.m.m10 ? this.showTip = !0 : Object(l["a"])("数据未填写完整，请填写完整后再提交")
                        }, putGame() {
                            if (this.name) {
                                let e = {
                                    name: this.name,
                                    list: ["", this.m.m1, this.m.m2, this.m.m3, this.m.m4, this.m.m5, this.m.m6, this.m.m7, this.m.m8, this.m.m9, this.m.m10]
                                };
                                if (localStorage.getItem("tableList")) {
                                    let t = JSON.parse(localStorage.getItem("tableList"));
                                    t.push(e), console.log("obj2", t), localStorage.setItem("tableList", JSON.stringify(t))
                                } else localStorage.setItem("tableList", JSON.stringify([e]));
                ...
                i = m,
                n = (A("f3dd"), A("2877")),
                c = Object(n["a"])(i, a, s, !1, null, "ace5013e", null);
            t["default"] = c.exports
        },
        "9efc": function(e, t, A) {},
        cc18: function(e, t, A) {
            ...
            var a = function() {
                ...
                o = l,
                m = (A("d297"), A("2877")),
                i = Object(m["a"])(o, a, s, !1, null, "7ed464c4", null);
            t["a"] = i.exports
        },
        d297: function(e, t, A) {
            "use strict";
