    ...
    ["chunk-945d2f6a"], {
        ...
        cc18: function(t, s, e) {
            ...
            var A = function() {
                ...
                c = i,
                o = (e("d297"), e("2877")),
                l = Object(o["a"])(c, A, a, !1, null, "7ed464c4", null);
            s["a"] = l.exports
        },
        d297: function(t, s, e) {
            "use strict";
        ...
        fadc: function(t, s, e) {
            ...
            var A = function() {
                    ...
                    return s("div", {
                        ...
                        staticClass: "diceTitle"
                    }, [t._v(t._s(t.diceList[0]))]), s("div", {
                        staticStyle: {
                            display: "flex",
                            width: "100vw",
                    ...
                    }, [t._v(t._s(t.diceList[1]))]), s("div", {
                        staticClass: "box box2"
                    }, [t._v(t._s(t.diceList[2]))]), s("div", {
                        staticClass: "box box3"
                    }, [t._v(t._s(t.diceList[3]))]), s("div", {
                        staticClass: "box box4"
                    }, [t._v(t._s(t.diceList[4]))]), s("div", {
                        staticClass: "box box5"
                    }, [t._v(t._s(t.diceList[5]))]), s("div", {
                        staticClass: "box box6"
                    }, [t._v(t._s(t.diceList[6]))])]), s("div", {
                        staticClass: "cube",
                        attrs: {
                            id: "cube2"
                        }
                    }, [s("div", {
                        staticClass: "box box7"
                    }, [t._v(t._s(t.diceList[7]))]), s("div", {
                        staticClass: "box box8"
                    }, [t._v(t._s(t.diceList[8]))]), s("div", {
                        staticClass: "box box9"
                    }, [t._v(t._s(t.diceList[9]))]), s("div", {
                        staticClass: "box box10"
                    }, [t._v(t._s(t.diceList[10]))]), s("div", {
                        staticClass: "box box11"
                    }, [t._v(t._s(t.diceList[11]))]), s("div", {
                        staticClass: "box box12"
                    }, [t._v(t._s(t.diceList[12]))])])]), s("button", {
                        staticClass: "goBtn",
                        attrs: {
                            type: "default"
                        },
                ...
                c = {
                    ...
                    data() {
                        return {
                            ...
                            one: 0,
                            two: 0,
                            list1: ["小狗", "舔", "吹", "吸吮", "轻抚", "轻咬", "按摩", "手", "肚脐", "嘴唇", "脚", "耳朵", "手指"],
                            list2: ["小狗", "轻舔", "咬", "吸", "打", "捏", "吹", "咪咪", "脚趾", "嘴巴", "JJ", "脖子", "PP"]
                        }
                    },
                    computed: {},
                    watch: {},
                    created() {},
                    mounted() {
                        if (1 == this.$route.params.type) this.titleName = "情趣骰子-初级骰子", this.diceList = this.list1;
                        else if (2 == this.$route.params.type) this.titleName = "情趣骰子-进阶骰子", this.diceList = this.list2;
                        else if (-1 != this.$route.params.type.indexOf("auto")) {
                            let t = JSON.parse(localStorage.getItem("diceList")),
                                s = this.$route.params.type.split("-")[1];
                            this.titleName = t[s].name, this.diceList = t[s].list
                        }
                    },
                    methods: {
                        go() {
                            this.gobtn && (this.gobtn = !1, this.turn())
                        }, turn() {
                            let t = document.getElementById("cube1"),
                                s = document.getElementById("cube2"),
                                e = 0,
                                A = 0;
                            if (e = Math.floor(6 * Math.random()) + 1, A = Math.floor(6 * Math.random()) + 1, e == this.one || A == this.two) return console.log("let", e, A), console.log("this", this.one, this.two), void this.turn();
                            switch (this.one = e, this.two = A, e) {
                                case 1:
                                    t.className = "cube", t.classList.add("rotate1");
                                    break;
                                case 2:
                                    t.className = "cube", t.classList.add("rotate2");
                                    break;
                                case 3:
                                    t.className = "cube", t.classList.add("rotate3");
                                    break;
                                case 4:
                                    t.className = "cube", t.classList.add("rotate4");
                                    break;
                                case 5:
                                    t.className = "cube", t.classList.add("rotate5");
                                    break;
                                case 6:
                                    t.className = "cube", t.classList.add("rotate6");
                                    break;
                                default:
                                    break
                            }
                            switch (A) {
                                case 1:
                                    s.className = "cube", s.classList.add("rotate1");
                                    break;
                                case 2:
                                    s.className = "cube", s.classList.add("rotate2");
                                    break;
                                case 3:
                                    s.className = "cube", s.classList.add("rotate3");
                                    break;
                                case 4:
                                    s.className = "cube", s.classList.add("rotate4");
                                    break;
                                case 5:
                                    s.className = "cube", s.classList.add("rotate5");
                                    break;
                                case 6:
                                    s.className = "cube", s.classList.add("rotate6");
                                    break;
                                default:
                                    break
                            }
                ...
                o = c,
                l = (e("445b"), e("2877")),
                n = Object(l["a"])(o, A, a, !1, null, "089ac0a4", null);
            s["default"] = n.exports
        }
    }
]);